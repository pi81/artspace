...
export const useArtwork = (slug: string) =>
  useSuspenseQuery(artworkDetailQueryOptions(slug));

export const useArtists = () => useSuspenseQuery(artistsListQueryOptions());

export const useArtist = (slug: string) =>
  useSuspenseQuery(artistDetailQueryOptions(slug));

export const useExhibitions = () =>
  useSuspenseQuery(exhibitionsListQueryOptions());

export const useExhibition = (slug: string) =>
  useSuspenseQuery(exhibitionDetailQueryOptions(slug));
